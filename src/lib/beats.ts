...
export const BEAT_COLUMNS =
  "id, title, slug, description, genre, mood, bpm, song_key, price, licenses, tags, cover_path, preview_path, master_path, media_source, youtube_url, status, featured, created_at, published_at";
