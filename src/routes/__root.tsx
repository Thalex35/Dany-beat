  ...
  head: () => ({
    meta: [
      ...
      { title: "Dany Beats — Instrumentales rap & trap premium" },
      {
        name: "description",
        content:
          "Écoutez et licenciez les instrumentales rap, trap et afro originales du producteur Dany Beats.",
      },
      { name: "author", content: "Dany Beats" },
      { property: "og:title", content: "Dany Beats — Instrumentales rap & trap premium" },
      {
      ...
      { name: "twitter:site", content: "@DanyBeats" },
    ],
    links: [
