...
import { i as formatPrice, s as slugify, t as BEAT_COLUMNS } from "./beats-B5LKfYIS.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.beats-tLQi466z.js
...
function AdminBeats() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: beats.isPending ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "space-y-3",
			...
			}) : (beats.data ?? []).length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
				title: "Aucun beat pour le moment",
				description: "Importez votre première instrumentale pour ouvrir le catalogue."
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
				className: "space-y-3",
				children: (beats.data ?? []).map((beat) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
