...
import { t as PlayerProvider } from "./player-B0FuGydA.mjs";
...
import { t as Route$15 } from "./beats_._slug-CAp6mlu3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DGwYJFKR.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-Bcw055Rk.css";
var Toaster$1 = ({ ...props }) => {
...
function useRealtimeSync(queryClient) {
	(0, import_react.useEffect)(() => {
		if (typeof window === "undefined") return;
		const channel = supabase.channel("app-live-sync").on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "beats"
		}, () => invalidateForTable(queryClient, "beats")).on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "comments"
		}, () => invalidateForTable(queryClient, "comments")).on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "likes"
		}, () => invalidateForTable(queryClient, "likes")).on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "cart_items"
		}, () => invalidateForTable(queryClient, "cart_items")).on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "analytics_events"
		}, () => invalidateForTable(queryClient, "analytics_events")).on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "site_settings"
		}, () => invalidateForTable(queryClient, "site_settings")).on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "profiles"
		}, () => invalidateForTable(queryClient, "profiles")).on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "user_roles"
		}, () => invalidateForTable(queryClient, "user_roles")).subscribe();
		return () => {
			supabase.removeChannel(channel);
		};
	}, [queryClient]);
}
function invalidateForTable(queryClient, table) {
	for (const queryKey of invalidatedQueryKeys[table] ?? []) queryClient.invalidateQueries({ queryKey: [...queryKey] });
}
...
var $$splitComponentImporter$12 = () => import("./routes-Bnj612-_.mjs");
...
var $$splitComponentImporter$10 = () => import("./about-DShSxs0l.mjs");
...
var $$splitComponentImporter$9 = () => import("./beats-CoPWsAv_.mjs");
...
var $$splitComponentImporter$8 = () => import("./contact-CXe9R51E.mjs");
...
var $$splitComponentImporter$6 = () => import("./cart-D4BNBCTz.mjs");
...
var $$splitComponentImporter$5 = () => import("./profile-CEgaGOpB.mjs");
