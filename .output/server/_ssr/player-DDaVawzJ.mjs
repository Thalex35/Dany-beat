...
//#region node_modules/.nitro/vite/services/ssr/assets/player-DDaVawzJ.js
...
function PlayerProvider({ children }) {
	...
	const [loop, setLoopState] = (0, import_react.useState)(false);
	...
	(0, import_react.useEffect)(() => {
		...
		const onEnd = () => {
			...
			const currentIndex = queueRef.current.findIndex((track) => track.id === currentRef.current?.id);
	...
	const play = (0, import_react.useCallback)(async (next, queue) => {
	...
	const setLoop = (0, import_react.useCallback)((value) => {
